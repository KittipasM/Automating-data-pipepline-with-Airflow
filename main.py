...
CONVERSION_RATE_URL = "conversion_url"
...
# Setting up Default Arguments : In case, You don't want to change default arguments. You can skip this process.


# Instantiate a DAG object
with DAG(
    "workshop_bq_load_dag",
